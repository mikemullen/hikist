...
describe "Static Pages" do
  ...
  describe "Home page" do
    ...
    describe "for signed-in users" do
      ...
      before do
        FactoryGirl.create(:hikelog, user: user, title: "Lorem ipsum")
        FactoryGirl.create(:hikelog, user: user, title: "Dolor sit amet")
        sign_in user
        visit root_path
      end
      ...
      describe "follower/leader counts" do
