...
describe "User Pages" do
  ...
  describe "profile page" do
    ...
    it { should have_selector('h3', text: "Hiker Stats") }
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user" do
        ...
        it "should increment the followed user count" do
          expect do
            click_button "Follow"
          end.to change(user.leaders, :count).by(1)
        end
  ...
  describe "following/leading" do
    ...
    describe "followed users" do
      ...
      it { should have_selector('title', text: full_title('Trailing')) }
      it { should have_selector('h3', text: 'Trailing') }
    ...
    describe "leading" do
      before do
        sign_in other_user
        visit leading_user_path(other_user)
      end

      it { should have_selector('title', text: full_title('Leading')) }
      it { should have_selector('h3', text: "Leading") }
